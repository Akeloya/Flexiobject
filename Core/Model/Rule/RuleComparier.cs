                ...
                case CoaFieldTypes.OptionList:
                    {
                        if (leftSide.TValue != null)
                        {
                            switch (operatr)
                            {
                                case CoaRuleComparisonsTypes.EqualTo:
                                    return ((IOptionListValue)leftSide.TValue).Alias == ((IOptionListValue)rightSide)?.Alias;
                        ...
                        result = ((IOptionListValue)leftSide.TValue)?.Alias == ((IOptionListValue)rightSide)?.Alias;
                    }
                    break;
