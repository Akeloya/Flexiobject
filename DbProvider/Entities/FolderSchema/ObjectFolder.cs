...
namespace DbProvider.Entities
{
    ...
    public class ObjectFolder
    {
        ...
        public Picture PictureOpen { get; set; }
        public Picture PictureClose { get; set; }
        public virtual WfState WfHistoryField { get; set; }
        ...
        public virtual ICollection<History> HistoriEntries { get; set; }
